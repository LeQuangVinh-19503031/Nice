...
public class JDialogDichVu_DatDoAn extends JDialog {
	 ...
	 * @param gd_DichVu
	 */
	public JDialogDichVu_DatDoAn(GD_DichVu gd_DichVu, String ten) {
		this.ten = ten;
		this.home = gd_DichVu;
		setTitle("ĐẶT ĐỒ ĂN");
		setModal(true);
		...
		contentPanel.setLayout(new BorderLayout(4, 4));
		{
			...
			{
				JLabel lblNewLabel = new JLabel("ĐẶT ĐỒ ĂN");
		...
		}
		{
			...
			panel.setLayout(new BorderLayout(4, 0));
			{
				...
				panel_1.setLayout(new BorderLayout(0, 4));
				{
					...
					{
						JLabel lblNewLabel_4 = new JLabel("THÊM ĐỒ ĂN");
		...
		}
		{
			...
			{
				JButton cancelButton = new JButton("HỦY ĐẶT");
